const MemberSection = () => {
  return (
    <div className="relative flex w-full max-w-[20rem] flex-col rounded-xl bg-gradient-to-tr from-[#AABC3A] to-[#AABC3A] bg-clip-border p-8 text-white shadow-md shadow-pink-500/40">
